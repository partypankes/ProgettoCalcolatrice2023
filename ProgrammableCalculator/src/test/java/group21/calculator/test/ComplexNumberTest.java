...
class ComplexNumberTest {
    ...
    void testComplexParse0() {
        ComplexNumber n = ComplexNumber.complexParse("3+4j");// -3+4j, -3-4j, -3 , 4j, -4j, 0+4j
    ...
    void testComplexParse3() {
        ComplexNumber n = ComplexNumber.complexParse("0+4j");// -3+4j, -3-4j, -3 , 4j, -4j, 0+4j
        assertTrue(n.getReal() == 0 && n.getImaginary() == 4);
    }

    @Test
    void testComplexParse4() {
        ComplexNumber n = ComplexNumber.complexParse("3");// -3+4j, -3-4j, -3 , 4j, -4j, 0+4j
        assertTrue(n.getReal() == 3 && n.getImaginary() == 0);
    }

    @Test
    void testComplexParse5() {
        ComplexNumber n = ComplexNumber.complexParse("-4j");// -3+4j, -3-4j, -3 , 4j, -4j, 0+4j
        assertTrue(n.getReal() == 0 && n.getImaginary() == -4);
    }
